...
- Fixed [HIGH]: Lore-dump list ("Sects that used people as fuel… Immortals… Artists of atrocity… New sects… New sovereigns…") replaced with 2 compressed sentences + "A thousand years. Nothing changed." Kept the stone-room memory as the single vivid example. ~75% of the enumeration list cut.
- Applied Global Patterns: Memory-length rule, "1 example > catalogue" principle, preserved somatic anchors (bones singing, fists clenching, river smell).
- Biggest clarity/pacing win: The futility now lands through compression — one vivid atrocity, one sentence of repetition, one metaphor ("wave/ocean") — instead of an inventory that lets the reader disengage.
---
