...
I looked at each of them. Briefly, systematically, the way I always did. Not because I needed to assess them but because they needed to be seen by me in the way that I had been seen by them. The exchange was necessary. The balance of exposure required it.
...
- Fixed [CRITICAL]/[HIGH]: 4th-wall author intrusion lines ("I'm not going to write…" / "putting them on a page") were already absent in this version — confirmed clean. Reduced measurement-metaphor overload (Writing Rules #41): cut "counted steps and measured distances and cataloged threats" and "habitual geometry of a mind that processed spatial data" down to single clean images.
- Applied Global Patterns: Show-don't-tell for Mrs. Zhao's shoulder (added wince/arc limitation so ambient qi doesn't read as free heal). Suspicion thread seeded via Gao's whispered "More than herbs" micro-line.
- Action upgrades (if any): None required — chapter is aftermath/stillness.
- Continuity fixes (if any): Mrs. Zhao's shoulder now shows partial improvement with lingering pain, consistent with 2-day-old dislocation + trace qi exposure.
- Biggest clarity/pacing win: Trimming the measurement jargon in Wei's mother's "three steps" passage lets the rhythm (Not two / Not four / Three) land harder without analytical clutter.
---
