...
- Fixed [CRITICAL]/[HIGH]: POV verified — chapter was already clean 1st person throughout. The only "she/her" instances (lines 39, 47) are in dialogue where characters discuss "the woman" in 3rd person, which is correct even in 1st-person POV. No pronoun rewrites needed.
- Applied Global Patterns: Show-not-tell (replaced named emotion "self-loathing of manipulation" → implied cost "manipulation always does"); tightened innkeeper description (removed awkward "possessed an indiscretion" construction); split heavy reflection sentence for punch ("Which was me." as standalone).
- Action upgrades: Added Wei dialog exchange in section 3 ("What's that one?" / "Bird." / "Doesn't look like a bird." / "It will.") per Rule 32 (Dialog bricht Introspektion) and Rule 38 (SoL scenes must work — this beat shows Wei's persistence and Yun's reluctant engagement).
- Continuity fixes: None needed — Xu Ran scar discovery, stream motif, and misdirection plot all consistent with surrounding chapters.
- Biggest clarity/pacing win: The added dialog exchange breaks the section 3 reflection wall, improves E:R ratio toward target, and gives Wei a character-revealing moment ("It will.") that thematically mirrors Yun's *Stay* — both are acts of stubborn faith in an unfinished thing.
---
