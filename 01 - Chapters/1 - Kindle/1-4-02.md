...
The memory surfaced — uninvited, the way they always did.
...
And now I had healed the arm of a boy who would die, and the arm was flexing in the moonlight, and he was staring at me with an expression I could not look at.
...
- Fixed [HIGH]: Memory/Reflection block (forge-girl → destroyed village → rationalization) cut by ~60%. Kept 1 core image (blistered hands, silence, healing) + "The girl was ash" + 1 sentence rationalization. Removed father-kneeling scene, extended rationalization paragraph, and over-specific timeline details.
- Applied Global Patterns: Memory-length rule (now ~12 sentences), "show don't explain" (cut the calculation/weighing paragraph), tighter retrospective voice.
- Biggest clarity/pacing win: The memory now hits like a knife instead of a novella — forge girl → ash → stopped healing — and the return to Wei lands harder because there's no padding between the gut-punch and the present moment.
---
