...
Across the clearing, Mrs. Liu had stopped on the path to watch. Her water bucket rested against her hip, forgotten.
...
- Fixed [HIGH]: Intercut training solo-procedure with village presence — Mrs. Liu watching from the path, children gathering at the clearing edge. Breaks the training montage with grounded observation beats.
- Biggest clarity/pacing win: Village witnesses transform the training from private drill into community event, foreshadowing Wei's growing role in the village.
---
