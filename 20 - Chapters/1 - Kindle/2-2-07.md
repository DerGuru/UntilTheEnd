...
- Fixed [HIGH]: Removed triple-restatement of the contrast ("wasn't kinder / knew it / reasonable decision based on nowhere"). Cut 6 redundant sentences. Added physical anchor (Wei stumbles, Yun adjusts pace) to SHOW staying instead of announcing it. Kept strongest reflection lines.
- Biggest clarity/pacing win: The "not-thinking" ending now lands harder because it's not pre-exhausted by three prior restatements of the same idea.
---
