...
- Fixed [HIGH]: "For not lying" show→tell pattern — cut 8-line post-show analysis to 1 line ("Aimed at Xu Ran. Delivered to me."); removed "Three words.", "Something shifted in my sternum.", and the entire Xu Ran aftermath paragraph ("His bowl was empty…The steadiness of aftermath.")
- Applied Global Patterns: Eliminated tell-after-show (redundant beat-counting, named emotion, over-described aftermath); let white space carry the weight of the 3-word exchange
- Biggest clarity/pacing win: "For not lying" now lands in silence and the scene pivots immediately to action, letting the reader feel the impact instead of being told about it.
