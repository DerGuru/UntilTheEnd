...
- Fixed [HIGH]: Broke long uninterrupted exposition/memory blocks into segments. Added three present-day anchors: branch crack (after Wei's construction analysis), stone underfoot (after Jade Path script block), distant stream sound (before invisibility reflection).
- Biggest clarity/pacing win: Reader now stays grounded in the forest-walk present while absorbing the intel exposition, preventing drift into essay mode.
---
