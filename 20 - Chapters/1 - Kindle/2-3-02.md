...
- Fixed [CRITICAL]: Added moth external event with 4+ new dialog exchanges (Wei: "Huh" / "Are they eating my qi?" / "Cool" / "A little cool" / "You could have let them stay" / "They were pretty"; Yun: "Don't move" / "Drinking" / "You're leaking" / "No"). Wei fully present and speaking in-character.
- Fixed [CRITICAL]: Chapter now has 9+ dialog exchanges total (5 original + 4 new). E:R ratio shifted from ~10:90 to ~55:45.
- Fixed [HIGH] Post-show analysis: Compressed analytical reflection (lines 37–48 original cut from 6 sentences to 3). Removed "qi-flow refinement, the channel development, the involuntary cultivation" catalog.
- Fixed [HIGH] Voice drift: Added humor/cynicism (Wei's "Cool"/"A little cool", offended moth, "a boy covered in moths the way other boys were covered in dirt"). Yun's dry observations restored.
- Fixed [HIGH] "the [N] of" tic: Reduced instances from 5+ to 2. Rewrote "the kind that came from," "the background sound of," "the fabric that contained it," "the worst part."
- Fixed [MED] Momentum dead: New closing hook — "beacons attract more than moths" + Yun listening for threats. Forward drive into Ch23 breakthrough.
- Applied Global Patterns: Dialog breaks introspection (Rule 32). SoL scene does work (Rule 38: Wei's leaking = stakes escalation). Sensory anchors on reflection (Rule 39: ice-smell, moth glow, fire crack).
- Action upgrades: Moth event as external beat — physically shows Wei's acceleration instead of telling it.
- Continuity fixes: Moths as qi-indicator foreshadows Ch23 breakthrough. "Three degrees since morning" bridges Ch21 climbing exhaustion → Ch23 nine-day advancement.
- Biggest clarity/pacing win: The moth scene *shows* Wei's dangerous acceleration through a concrete external event instead of Yun analyzing it in her head — the reader sees the problem at the same time she does.
