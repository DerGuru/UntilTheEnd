...
- Fixed [HIGH]: Cut ~30% of self-argumentation — trimmed barrier analysis (13→7 sentences) and Xu Ran consolidation passage (5→2 sentences). Removed redundant technical detail while preserving the stakes math.
- Biggest clarity/pacing win: The barrier-failure realization now lands as a gut punch ("My barriers would not be enough.") instead of a slow calculation.
---
