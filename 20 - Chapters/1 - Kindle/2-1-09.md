...
- Fixed [HIGH] Zero dialog / E:R ~25:75: Added 3 dialog exchanges — (1) dumplings/hunger exchange after the stream, (2) confrontation when Yun stops walking ("You're also lying"), (3) qi-suppression reaction ("That felt weird"). Total dialog exchanges now: 5 (stream banter, dumplings, confrontation, odds negotiation, suppression).
- Fixed [HIGH] Part 1 closer climactic weight: Expanded qi-signature detection into active threat — two searchers flanking, Yun forced to make tactical decisions (course change, qi-trail masking, disclosure to Wei). The Part now closes on a tightening net rather than ambient unease.
- Fixed [HIGH] Wei absent: Wei now has 10+ spoken lines across the chapter. He argues, jokes, reads Yun's body language, and challenges her evasions — present and active throughout.
- Fixed [MED] Melancholy-only voice: Added dry humor — "sixty percent" odds negotiation, "a rice ball isn't food, it's a suggestion of food," "then I want dumplings in a forest," Yun's internal "I found that irritating. Also — impressive."
- Applied Global Patterns: Dialog breaks introspection (Rule 32); action-beat tags replace said-tags; subtext in dialog (Wei says "you're also lying" — reads situation without being told); OP-vs-Alltag humor (Yun can mask qi signatures but can't win an argument with a thirteen-year-old).
- Biggest clarity/pacing win: The "sixty percent" exchange gives Wei agency in the threat scene — he's not a passive charge but a participant who forces Yun to be honest, which raises the stakes of their dynamic heading into Part 2.
