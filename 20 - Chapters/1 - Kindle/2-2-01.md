...
That evening: fire. Small. Wei cooked — rice with dried herbs from his bundle. The edges burned. The center stayed raw. He studied the result like he was starting to suspect the rice was doing it on purpose.
...
He stabbed at the rice with his chopstick. I ate my portion wordlessly. Wei cooked, and not-eating would mean questions — questions I was maintaining active avoidance around.
...
The question was sharper than I'd expected from him. I let it sit for a beat.
...
- Fixed [CRITICAL] E:R ratio: Added ward stones discovery scene (external content), cooking dialog exchange ("You could cook" / "Learning opportunity"), and pre-sleep dialog exchange ("Are we being followed?"). Ratio shifted from ~15:85 to ~45:55.
- Fixed [CRITICAL] Wei invisible: Added 6 new dialog exchanges (ward stones ×3, cooking ×1, bedtime ×2). Total exchanges now 9 across the chapter. Wei present and active throughout.
- Fixed [HIGH] Post-showing analysis: Cut 3 paragraphs of Yun over-interpretation (false trail explanation, "cost wasn't the detour" paragraph, final excuse-sentence). False trail condensed to action beats.
- Fixed [HIGH] "the [N] of someone who" pattern: Replaced "the vacancy of someone who had stopped caring" → "eyes that had stopped tracking"; replaced "the intensity of someone beginning to suspect" → "like he was starting to suspect the rice was doing it on purpose."
- Fixed [MED] Melancholy unleavened by humor: Added "Learning opportunity" exchange, rice-with-a-vendetta line, and the dry "That's a *go to sleep*" beat.
- Applied Global Patterns: Dialog breaks introspection (Rule 32); SoL scene works — ward stones build world, cooking builds relationship, bedtime builds stakes (Rule 38); Yun acts actively via false trail and route change (Rule 37).
- Action upgrades: Ward stones discovery adds external texture and worldbuilding without new plot.
- Continuity fixes: Pre-sleep "Are we being followed?" sets up Wei's observational sharpness referenced in Ch11. Cough foreshadowing preserved for Ch11 opening.
- Biggest clarity/pacing win: The bedtime exchange ("Are we being followed?" / "That's not a no") transforms the chapter's emotional engine — Wei is no longer cargo, he's a participant who notices things, and that raises the stakes for Yun's midnight detour.
