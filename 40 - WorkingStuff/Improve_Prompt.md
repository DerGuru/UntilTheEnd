...
- Writing Rules.md
- StyleDNA.md
- 6-PlotTurn2-Outline.md + 7-Resolution-Outline.md (unter "10 - Outlines")
- 14 Szenen-Outlines unter "10 - Outlines/SzenenOutlines"
...
OUTPUT:
- Write a file named {{ImprovementsFile}} to disk in "40 - WorkingStuff" 
- if the file exists: Update on disk (edit in place). Do NOT create a second file.

Terminology normalization (use consistently in findings):
- Beat abbreviations: H, PT1, P1, M, P2, PT2, R
- Note: PP2 is an alias for P2 (Pinch 2). Use **P2** in the report for consistency.
