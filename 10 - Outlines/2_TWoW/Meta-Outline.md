...
| **B3** | **Ash** | Silence | Was nach dem Feuer bleibt, bevor die Stille einsetzt |
| **B4** | **Dust** | Echoes | Xu Ran folgt Spuren im Staub — Echos sind das, was ankommt |
| **B5** | **Cracks** | Fractures | Risse sieht man von außen, Brüche von innen |
| **B6** | **Glass** | Mirrors | Das Material hinter dem Spiegel — transparent, zerbrechlich |
| **B7** | **Ink** | Clouds | Was Wolken auf Papier festhält — der Chronist |

---

## Perspektive & Erzählstimme

- **POV:** Dritte Person, eng (limited) — Kontrast zur Ich-Perspektive der Hauptreihe
- **Wechsel:** Kapitelweise zwischen Wei und Xu Ran (B1–B3), danach nur Xu Ran (B4–B7)
- **Chronologisch:** Die Kapitel sind zeitlich geordnet, nicht nach POV-Blöcken. Der Leser springt zwischen Wei und Xu Ran, wie die Kamera in einem Film.
- **Ton Wei:** Warm, direkt, bodenständig. Sieht Yun als Person, nicht als Macht. Humor durch Unverständnis.
- **Ton Xu Ran:** Analytisch, ehrgeizig, zunehmend unsicher. Sieht Yun als Anomalie, dann als Rätsel, dann als Mensch.
...
- **[卫]** = Wei
- **[笔]** = Pencil (Lian Zhuo)
- **[隐]** = Hermit (der Einsiedler-Kultivator, Immortal+)

---

## Neue POV-Figuren (ab B3+)
...
## Xiǎohú-Thread (kein POV — beobachtetes Phänomen)

### Konzept
Xiǎohú ist ein Fuchs-Geist, der durch **Proximity-Verstärkung** in Yuns Qi-Feld über Monate „vertieft" wurde — analog zu Weis Kern-Beschleunigung, aber mit anderen Symptomen. Nicht rohe Kraft, sondern: **Wahrnehmung, Tarnung, Instinkt.** Was bei einem Fuchs natürlich ist, wird durch Yuns Qi übernatürlich.

### Timeline
| Zeitpunkt | Event | Sichtbarkeit |
|-----------|-------|-------------|
| **B4 (Poison-Experiment)** | Xiǎohú spürt das Experiment. Beginnt zu folgen. Immer außer Sichtweite. | Unsichtbar für alle |
| **B5 Mitte** | Wird „intelligent genug" für rationale Gedanken. Fokus: rein auf Yun. | Unsichtbar; Xu Rans Körper weicht ihr unbewusst aus |
| **B5 Part 7** | Zeigt sich Yun zum ersten Mal. Bewusste Entscheidung. | Yun sieht: „minor spirit beast, too simple for intelligence" |
| **B6** | Täglich in Yuns Nähe. Wird besser im Tarnen. Trackt Sekte-Scouts. | Yun: gewöhnt sich, hinterfragt nicht. Xu Ran: bemerkt Anomalien |
| **B7** | Xu Ran versteht es. Schreibt es in die Chronik. | Xu Ran dokumentiert: „Sie hat ihn nie gesehen." |

### Warum Yun es nicht merkt
1. **Anfang (B4-B5):** Yun hat Trauer, Poison-Experiment, Apathie → kein Grund, einen Fuchs zu hinterfragen
...
B3: Verlust aus der Nähe (Wei: stirbt als Handelnder | Xu Ran: Zeuge, Entscheidung)
B4: Suchen, ohne zu wissen wonach (Xu Ran findet Yun, findet nicht sich)
B5: Sehen, was andere nicht sehen (Xu Ran als Außenbeobachter der Wahrheit)
B6: Verstehen, was man nicht ändern kann (Xu Ran als Katalysator)
B7: Aufschreiben und Loslassen (Xu Ran als Chronist, dann: eigener Weg)
```
...
|---|---|---|---|
| **Sterblichkeit von innen** | B1: Wei ist 12, das Leben ist kurz und kostbar | B3: Wei stirbt — Sterblichkeit wird REAL | B7: Xu Ran lebt weiter, WEIL er sterblich ist |
| **Ambition vs. Sinn** | B1: Xu Ran will aufsteigen um jeden Preis | B3-4: Aufstieg zerbrochen, Sinn verloren | B7: Sinn ≠ Aufstieg. Chronik als Weg. |
...
## Verhältnis zur Hauptreihe: Szenen-Strategie

### Bekannte Szenen (aus Yuns POV erzählt)
- **Nacherzählt:** Key-Moments, die durch die neue Perspektive ANDERS wirken
  - Beispiel B1: Yun tötet das Wildschwein — Wei sieht: eine Frau, die gähnt und ein Monster zerlegt. Er ist 12. Er versteht NICHTS.
  - Beispiel B3: Weis Tod — aus SEINER Perspektive. Was er in seinen letzten Sekunden denkt.
- **Referenziert:** Szenen, die Yun beschreibt, die Wei/Xu Ran nur am Rand mitbekommen
  - Beispiel B1: Yuns Erinnerungen — Wei sieht nur: „Sie starrt ins Leere. Wieder."

### Neue Szenen (in der Hauptreihe unsichtbar)
- Weis Familienleben: Vater, Mutter, Geschwister, Armut, Alltag
- Xu Rans Spirit-Beast-Jagden: Action, Progression, Hybris
- Xu Rans gescheiterte Tribulation von INNEN
- Was das Dorf über Yun denkt
- Xu Rans Suche nach Yun (B2–B4)
- Xu Rans Verhältnis zu seiner Sekte
...
Buch 2:  Wachstum ——→ Schmerz (die Dornen des Stärkerwerdens)
Buch 3:  Stolz ——→ OPFER ——→ Asche
Buch 4:  Leere ——→ Suche ——→ Unfreiwillige Bindung
Buch 5:  Beobachtung ——→ Erkenntnis von außen
Buch 6:  Katalysator ——→ Akzeptanz (nicht seine — IHRE)
Buch 7:  Chronik ——→ Abschied ——→ Eigener Weg
```
...
|---|---|
| B1 → B2 | Xu Ran am Boden, gebrochen. Wei verändert. Die Welt reagiert. |
| B2 → B3 | Weis Leuchten als Zeitbombe. Xu Rans Wiederauftauchen. |
| B3 → B4 | Wei tot. Xu Ran hat keinen Grund zu bleiben — und bleibt trotzdem. |
| B4 → B5 | Xu Ran ist Begleiter. Sieht Dinge, die Yun nicht sieht. |
| B5 → B6 | Am Rand der Erkenntnis — Xu Ran HAT die Puzzleteile. |
| B6 → B7 | Die Wahrheit ist ausgesprochen. Jetzt: aufschreiben. |

---

## Xu Rans Arc (vertieft, nicht neu)

Der Arc aus der Hauptreihe wird von INNEN erzählt:
...
- **B5-7: Kern-Heilung + Gedächtnis-Überschreibung.** Yuns Proximity heilt den gebrochenen Kern — aber überschreibt Xu Rans Erinnerungen. Der Prozess beginnt unsichtbar (B5 Part 4-5: 2-3 Einträge, die er nicht erinnert), wird zum Muster (B6 Part 1-2: systematische Lücken), zum bewussten Wissen (B6 Part 3: Meridian-Skip-Test = Beweis), zur bewussten Entscheidung (B6 Part 3-4: Schweigen, weil Yun ihn sonst wegschickt), zur täglichen Routine (B6 Part 4: morgens Notizbuch lesen, sich selbst rekonstruieren, die Rolle spielen). **WENDEPUNKT: Nach Yuns Selbsterkenntnis („I am it", B6 Midpoint) STOPPT die Überschreibung. Auch wenn Yun weiterhin unbewusst Realität verändert — Xu Rans Erinnerungen werden nicht mehr gelöscht. Ihr Kern hat aufgehört, ihn als Bedrohung/Fremdkörper zu behandeln. Die Erkenntnis hat etwas in der Mechanik verändert, nicht nur im Bewusstsein.** Ab B7 kann Xu Ran frei erinnern — aber die LÜCKEN aus B5-6 bleiben. Was gelöscht wurde, ist weg. Das zweite Notizbuch, das als Zuneigung begann und zur Überlebensakte wurde, wird in B7 zur Chronik. Die Wahl „Feder statt Kern" (B7 Epilog) ist nicht Edelmut — Kultivation könnte die Überschreibung REAKTIVIEREN. Der geheilte Kern ist Geschenk UND Bombe.
